...
public class OAuth2Configuration extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    public OAuth2Configuration(@Qualifier("dataSource") DataSource dataSource, PasswordEncoder passwordEncoder, UserDetailsService userDetailsService, ClientDetailsService clientDetailsService, @Qualifier("authenticationManagerBean") AuthenticationManager authenticationManager) {
